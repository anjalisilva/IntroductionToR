...
10. [2 marks] Can you mix positive and negative integers simultaneously when subsetting a vector? Yes or No?$\text{\underline{  ANSWER  }}$ Justify your answer by showing one example. You may show this using 'missingValueVector'. Provide your code for the example.
\vspace{18pt}
