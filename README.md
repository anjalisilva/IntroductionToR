...
Learners will know how to:
  1. Comfortably access R, identify options for working with R, layout purpose of using RStudio and RProjects, understand best R coding practices, and place R among other data science tools. Further, learners will be able to navigate RStudio to write scripts, use different R data types and structures, use built-in R commands and accessing external functions via downloading R packages. This will be assessed in Assessment 1.
  2. Describe and define features of a dataset by applying manipulation and wrangling techniques. Learners will be able to access built-in R data or import external datasets into R, identify data structures and describe them, apply manipulation techniques to reshape the datasets, detect missing values, clean data, summarize data, export data and report findings. This will be assessed in Assessment 2.
  3. Explain the strengths and limitations R workflows and analyses using concepts of reproducibility, bias, diversity, inclusion, ethical considerations, equity concepts, data security and best coding practices. This will be assessed in Assessment 3.
  4. Analyze and build a strategy for designing functions that can perform simple analyses and exploratory plots as appropriate for data type and story to be told. 
...
-   Teaching Assistant (TA) for this is **Tia Harrison**, MSc, PhD Candidate (she/her). 
For emails to the TA, use tia.harrison@mail.utoronto.ca.
...
| Thursday <br>24 November <br>6pm-8pm  	| **Industry case study**<br><br>- speaker TBA                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 	|
