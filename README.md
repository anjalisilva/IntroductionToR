...
Learners will know how to:
  1. Comfortably access R, identify options for working with R, layout purpose of using RStudio and RProjects, and understand best R coding practices. Further, be able to navigate RStudio to write scripts using both built-in commands and by accessing external functions via downloading R packages. This will be assessed in Assignment 1.
  2. Access built-in R data or import external datasets into R and apply manipulation techniques to reshape the datasets, detect missing values, clean and summarize data. This will be assessed in Assignment 2.
...
|---------------------------------------	|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------	|
| Monday <br>7 November<br>6pm-8pm      	| Hello world and work practices <br><br>- Data science tools, why R, options for working with R, and citing R.<br>- Downloading R, RStudio, its anatomy and navigating RStudio environment.<br>- Layout best R coding practices. <br>- Understand importance of reproducibility, working with RProjects, and identify components of a reprex.<br>- Identify R syntax, how to get help, and use of built-in functions.<br>- Perform mathematical operations in R. <br>- Learn how to install R packages (CRAN, Bioconductor, GitHub).<br>- Identify different file types and diagnosing of errors. 	|
