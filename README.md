...
Learners will know how to:
  ...
  2. Access built-in R data or import external datasets into R and apply manipulation techniques to reshape the datasets, clean data and summarize data. This will be assessed in Assignment 2.
